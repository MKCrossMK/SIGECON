<x-app-layout>
    ...
    <div id="border_container" class="page-content container">
        ...
        <div>
            <h2 class="text-center font-bold uppercase">Reporte de Hoy</h2>
        ...
        @if (count($policies) > 0 || count($p_payment) > 0 || count($p_renovation) > 0 || count($p_cancelation) > 0)
            ...
            @if (count($p_cancelation) > 0)
                ...
                <p class="text-right font-bold"> Total General: <span class="font-normal">{{number_format($total, 2)}}</span></p>
