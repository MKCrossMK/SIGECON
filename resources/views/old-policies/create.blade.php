<x-app-layout>
    ...
    <div class="container mt-3">
        ...
        <div class="title_div">
            <h1 class="title_views text-center"><i class="fa-solid fa-file-circle-plus mr-2 color-gold"></i></i>Nueva
                Poliza de Sistemas Anteriores</h1>
        </div>

        <div class="div-view-policies">
            <div>
                <form enctype="multipart/form-data" action="{{ route('old.policies.store') }}" method="POST">
                    @csrf

                 
                <div class="row mb-2 align-items-center">
                    <div class="col col_label_input_align">
                            <label for="number_policy" class="date_title">Numero de Poliza:</label>
                            <input type="text" id="number_policy" name="number_policy" class="form-control"
                                placeholder="Nº Poliza" aria-label="Fecha Inicio" value="{{old('number_policy')}}" required>
                            @error('number_policy')
                    ...
                    <div class="col col_label_input_align">
                        ...
                        <select id="status" name="status" class="form-control" required>
                            <option value="" selected disabled>Seleccione el estado de la poliza</option>
                    ...
                    <div class="row mb-2 align-items-center">
                        <div class="col col_label_input_align">
                            ...
                            <input type="date" id="date_start" name="date_start" class="form-control"
                                placeholder="Fecha Inicio" aria-label="Fecha Inicio" value="{{old('date_start')}}" required>
                        ...
                        <div class="col col_label_input_align">
                            ...
                            <input type="date" id="date_end" name="date_end" class="form-control"
                                placeholder="Fecha Fin" aria-label="Fecha Fin" value="{{old('date_end')}}" required>
                                    ...
                                    <select name="interest_rate" id="interest_rate" class="form-control">
                                        @foreach ($interest_rates as $interest)
                                            <option
                                                ...
                                                @if ($interest->description == 'preference') id="interest_preference" disabled readonly @endif
        ...
        <script src="{{ asset('js/old-policies.js') }}"></script>
    ...
    <script>
                new Notify({
                status: "error",
                title: "Numero de Poliza no proporcionado",
                text: '{{ $message}}',
                effect: "slide",
                speed: 300,
                showIcon: true,
    ...
    <script>
                new Notify({
                status: "error",
                title: "Fecha de Emision no proporcionada",
                text: '{{ $message}}',
                effect: "slide",
                speed: 300,
                showIcon: true,
    ...
    <script>
        new Notify({
        status: "error",
        title: "Fecha de Vencimiento no proporcionada",
        text: '{{ $message }}',
        effect: "slide",
        speed: 300,
        showIcon: true,
    ...
    @error('client_id')
        <script>
            new Notify({
                status: "error",
                title: "Cliente no proporcionada",
                text: '{{ $message}}',
                effect: "slide",
                speed: 300,
                showIcon: true,
