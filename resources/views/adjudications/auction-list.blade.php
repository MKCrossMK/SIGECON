                ...
                <table cellspacing="0" cellpadding="0">
                    ...
                    <tbody>
                      ...
                      <tr>
                          ...
                          <td class="desc">Poliza: {{$adjudication->auctionDetail->policy()->number_policy}} 
                             <small>
                                @foreach ($adjudication->auctionDetail->policy()->policyDetails as $item)
                         ...
                         {{-- <td>{{$adjudication->auctionDetail->buyer->auctionParticipant->name}}</td> --}}
                          <td class="unit">{{number_format($adjudication->auctionDetail->auctioned_price, 2, '.', ',')}} DOP</td>
                      </tr> 
                      @endforeach
                    </tbody>
