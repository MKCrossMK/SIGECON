...
class Policy extends Model
{
    ...
    public function referrer(){
        return $this->belongsTo(PolicyReferrer::class, 'referrer_id', 'id');
    }
    ...
    public function renovations(){
        return $this->hasMany(PolicyRenovation::class, 'policy_id', 'id');
    }

    public function cancelations(){
        return $this->hasMany(PolicyCancelation::class, 'policy_id', 'id');
    }
}
