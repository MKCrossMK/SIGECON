<x-app-layout>
    ...
    <div id="border_container" class="page-content container">
        ...
        <div>
            ...
            <h3 class="text-right">{{$policyCancelation->policy->branch_office->province}}</span></h3>        
        ...
        <table class="table" id="table">
            ...
            <tbody>
                <tr>
                    <td class="text-center">{{number_format($policyCancelation->policy->capital_pay, 2)}}</td>
