<x-app-layout>
    ...
    <div id="border_container" class="page-content container">
        ...
        <div>
            ...
            <h3 class="text-right">{{$oldPolicyPayment->policy->branch_office->province}}</span></h3>        

        </div>

        <div class="mt-5">
            <h2 class="font-bold uppercase">Nombre: <span class="font-normal uppercase">{{$oldPolicy->clients->name . " " . $oldPolicyPayment->policy->clients->lastname}}</span></h2>
            <h3 class="font-bold uppercase">Cedula: <span class="font-normal">{{$oldPolicyPayment->policy->clients->cedula}}</h3>
        </div>
