        ...
        <div class="page-header text-blue-d2">
            <h1 class="page-title text-secondary-d1">
                <small class="page-info">
                    ...
                    Nº Poliza : {{ $oldPolicyDetail->policy->number_policy}}
                </small>
            </h1>
        </div>
        ...
        <div class="container px-0">
            <div class="row mt-4">
                <div class="col-12 col-lg-10 offset-lg-1">
                    ...
                    <form action="{{ route('old.policies.detail.update', $oldPolicyDetail->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PATCH')
                        <div class="item-row">
                            <div class="div_article mb-2 ">
                                <div class="row align-items-center">
                                    <div class="col-4">
                                        @if ($oldPolicyDetail->image == null)
                                        <img id="article_img" class="img-fluid img_article_edit mb-3" src="{{ asset('img/img-noavble.jpg') }}"
                                        @else
                                        <img id="article_img" class="img-fluid img_article_edit mb-3" src="{{ asset($oldPolicyDetail->image) }}"
                                        @endif
                                            alt="Imagen Articulo">
                                    ...
                                    <div class="col">
                                        <textarea class="form-control w-100 mb-2" id="description" name="description" rows="5">{{ $oldPolicyDetail->description }}</textarea>
                                        <div class="row">
                                            <div class="col">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text"
                                                        ...
                                                        value="{{ $oldPolicyDetail->carat }}" readonly>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" id="weight"
                                                        ...
                                                        value="{{ $oldPolicyDetail->weight }} Gramos" readonly>
                                                </div>
                                            </div>
                                            <div class="col">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" id="valued_price"
                                                        class="form-control input_border"
                                                        value="DOP {{ number_format($oldPolicyDetail->valued_price) }}"
                                                        readonly>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="input-group">
                                            ...
                                            <input type="text" id="loan_price"
                                                ...
                                                value="DOP {{ number_format($oldPolicyDetail->loan_price, 2, ',', ' ') }}" readonly>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="mt-5 mb-3">
                            <div class="row">
                                <div class="col">
                                    <a href="{{ route('old.policies.show', $oldPolicyDetail->policy->id) }}" class="btn btn_blue btn-block"
...
@endif
    ...
    <script>
        ...
        function CancelUploadFile(){
            photo.src = `{{ asset($oldPolicyDetail->image) }}` ;
